...
<div class="row mb-3">
    ...
    <div class="col-md-8">
        ...
        <input type="text"
            ...
            value="{{ old('school_name', $record->school_name ?? '') }}" required>
             @error('school_name')
            <div class="invalid-feedback">{{ $message }}</div>
             @enderror
    </div>
...
<div class="mb-3">
    ...
    <input type="date"
        ...
        value="{{ old('record_date', $record->record_date ?? '') }}" required>
    @error('record_date')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
                    ...
                    <!-- ปุ่ม -->
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="bi bi-save me-1"></i> แก้ไขข้อมูล
                            </button>
                        </div>
            </form>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ✅ ฟังก์ชันคำนวณเกรดจากคะแนน (เหมือนหน้าเพิ่ม)
