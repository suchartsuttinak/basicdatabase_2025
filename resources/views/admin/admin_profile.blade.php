                            ...
                            <div class="align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="overflow-hidden ms-4">
                                        ...
                                        <p class="my-1 text-muted fs-16">{{ $profileData->email }}</p><span </div>
                                    </div>
                                </div>
                                ...
                                {{-- <ul class="nav nav-underline border-bottom pt-2" id="pills-tab" role="tablist">
                                    ...
                                    <a class="nav-link p-2 active" id="profile_about_tab" data-bs-toggle="tab"
                                        href="#profile_about" role="tab" aria-selected="true">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link p-2" id="profile_experience_tab" data-bs-toggle="tab"
                                        href="#profile_experience" role="tab" aria-selected="false" tabindex="-1">
                                ...
                                <li class="nav-item" role="presentation">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link p-2" id="setting_tab" data-bs-toggle="tab"
                                            href="#profile_setting" role="tab" aria-selected="false" tabindex="-1">
                                            <span class="d-block d-sm-none"><i class="mdi mdi-school"></i></span>
                    ...
                    <form action="{{ route('profile.store') }}" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <img id="showImage"
                                        src="{{ !empty($profileData->photo) ? url('upload/user_images/' 
                                        . $profileData->photo) : url('upload/no_image.jpg') }}"
