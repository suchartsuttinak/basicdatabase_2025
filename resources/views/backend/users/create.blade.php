...
<div class="container-fluid py-3 user-form-page">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
        <div>
            <h2 class="mb-1 fw-bold user-form-title">เพิ่มผู้ใช้งาน</h2>
            <div class="text-muted">สร้างบัญชีใหม่และกำหนดสิทธิ์การใช้งาน</div>
        </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="user-profile-upload-box">
                            <div class="user-upload-preview-wrap">
                                <img src="{{ asset('upload/no_image.jpg') }}" id="showImage" class="user-upload-preview" alt="preview">
                            </div>
                            ...
                            <div class="form-text mt-2">รองรับไฟล์ jpg, jpeg, png, webp ขนาดไม่เกิน 2MB</div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label user-label">รหัสผ่าน <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label user-label">ยืนยันรหัสผ่าน <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" rows="4"
                                    class="form-control user-input-modern @error('address') is-invalid @enderror">{{ old('address') }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
